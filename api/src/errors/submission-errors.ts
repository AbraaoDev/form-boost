...
export class InactiveFormError extends BaseError {
  constructor(message: string = 'This form has been disabled and does not allow changes') {
    super(message, 'INACTIVE_FORM', 403);
  }
}

export class SubmitBlockedError extends BaseError {
  constructor(message: string = 'The response is protected and cannot be removed due to retention policies') {
